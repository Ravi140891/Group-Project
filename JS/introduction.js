...
let message = [
  {
    id: "Thor",
    text: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatem, ipsa temporibus. Velit.",
    date: "24/12/2022",
    dd: "24",
    hour: "11:20:25 AM",
    gender: gender,
  ...
  {
    id: "Tom",
    text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium illo illum eligendi fugiat, ab a placeat. Hic mollitia sint illo?",
    date: "24/12/2022",
    dd: "24",
    hour: "11:22:25 AM",
    gender: gender,
  ...
  {
    id: "Sam",
    text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium illo illum eligendi fugiat, ab a placeat. sint illo?",
    date: "24/12/2022",
    dd: "24",
    hour: "11:26:25 AM",
    gender: gender,
  ...
  {
    id: "Tom",
    text: "Lorem ipsum dolor sit amet adipisicing elit. Accusantium illo illum eligendi fugiat, ab a placeat. Hic mollitia sint illo?",
    date: "24/12/2022",
    dd: "24",
    hour: "11:27:55 AM",
    gender: gender,
  ...
  {
    id: "Olivia",
    text: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut, perferendis cupiditate deleniti unde possimus labore minima architecto ipsam beatae natus! Impedit laboriosam soluta ab quibusdam dolor.",
    date: "24/12/2022",
    dd: "24",
    hour: "11:41:50 AM",
    gender: "female",
...
let message1 = JSON.parse(localStorage.getItem("message")) || [];
...
function createItem(msg) {
  ...
  listItem.innerHTML = `<span class="profile-pic"><img src="${
    ...
    msg.dd == dd ? "Today" : msg.dd == dd - 1 ? "Yesterday" : current
  } at ${msg.hour}</span></div><p>${msg.text}</p></div>`;
...
chatBox.addEventListener("submit", (e) => {
  ...
  message1.push(msg);
  localStorage.setItem("message", JSON.stringify(message1));
  createItem(msg);
  autoScroll();
  inputMsg.value = "";
});
